...
pub struct EspHomeFrameReader {
    connection: ReadHalf<Async<TcpStream>>,
    buffer: Vec<u8>,
    read_pos: usize,
    write_pos: usize,
}

impl EspHomeFrameReader {
    pub fn new(connection: ReadHalf<Async<TcpStream>>, buffer_size: usize) -> Self {
